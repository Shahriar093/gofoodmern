...
export default function AdressForm() {
    ...
    return (
        <div className='formBody'>
            <Navbar />
            <div className='row'>
                <form className='col-8 offset-3' onSubmit={handleSubmission}>
                    ...
                    <div className="form-group col-sm-12 col-md-6 col-lg-8 m-2">
                        ...
                        <input type="text" className="form-control" id="inputAddress" placeholder="116-North, CUET" />
                    </div>
                    <div className="form-row m-2">
                        <div className="form-group col-md-6">
                            <label htmlFor="Mobile">Mobile</label>
                            <input type="text" className="form-control" id="inputmobile" placeholder='+8801*********' />
                        </div>
                        <div className="form-group col-md-6">
